---
name: code-complete
description: Use when building or reviewing code. Apply design principles from 'Code Complete'. Load this skill to enforce architectural and code quality rules inspired by the book.
version: 1.0.0
