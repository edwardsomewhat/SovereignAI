...
description: Use when building or reviewing code. Apply design principles from 'Working Effectively With Legacy Code'. Load this skill to enforce architectural and code quality rules inspired by the book.
version: 1.0.0
...
# Working Effectively With Legacy Code Rules
