...
description: Use when building or reviewing code. Apply design principles from 'A Philosophy Of Software Design'. Load this skill to enforce architectural and code quality rules inspired by the book.
version: 1.0.0
...
# A Philosophy Of Software Design Rules
