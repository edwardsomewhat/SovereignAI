...
description: Use when building or reviewing code. Apply design principles from 'Patterns Of Enterprise Application Architecture'. Load this skill to enforce architectural and code quality rules inspired by the book.
version: 1.0.0
author: derived from mattpocock/agent-rules-books
license: MIT
metadata:
  hermes:
    tags: [software-engineering, architecture, code-quality, book-rules]
    related_skills: []
---

# Patterns Of Enterprise Application Architecture Rules
